...
**Creación de una tabla a par2r del resultado de una consulta compleja.
Descripción de la consulta: Queremos analizar el número de veces que han
...
nacimiento, el 9po de membresía que 9ene contratada y el número de entradas
